...
DEPENDENT_LIBS = {
    ...
    'libssh': {
        'order' : 3,
        'shadow': True,
        'url'   : 'https://git.libssh.org/projects/libssh.git/snapshot/libssh-b1bbd20dfa8adc784c03fa74d8c81c30671d011b.tar.gz',
        'sha1'  : '825bfeab4094d774fbf2f75e4114471a35d4ff66',
        'target': {
            'mingw-w64': {
