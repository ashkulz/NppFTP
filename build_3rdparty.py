...
DEPENDENT_LIBS = {
    'openssl': {
        ...
        'sha1'  : 'a06b067b7e3bd6a2cb52a06f087ff13346ce7360',
        'target': {
            'mingw-w64': {
    ...
    'libssh': {
        'order' : 3,
        'shadow': True,
        'url'   : 'https://git.libssh.org/projects/libssh.git/snapshot/libssh-0.10.4.tar.xz',
        'sha1'  : '968909684dacc24139b6dd27cce99a8cba699d5c',
        'target': {
            'mingw-w64': {
