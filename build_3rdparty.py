...
DEPENDENT_LIBS = {
    'openssl': {
        ...
        'sha1'  : '79511a8f46f267c533efd32f22ad3bf89a92d8e5',
        'target': {
            'mingw-w64': {
    ...
    'libssh': {
        'order' : 3,
        'shadow': True,
        'url'   : 'https://git.libssh.org/projects/libssh.git/snapshot/libssh-0.10.2.tar.xz',
        'sha1'  : '5e5fbe8cb24702a06fca4303bb66d68c2a2e644a',
        'target': {
            'mingw-w64': {
