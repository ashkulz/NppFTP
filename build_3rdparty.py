...
DEPENDENT_LIBS = {
    ...
    'libssh': {
        'order' : 3,
        'shadow': True,
        'url'   : 'https://git.libssh.org/projects/libssh.git/snapshot/libssh-dcc0b9d7aa092bd4bc9f50273e40a3777f9f8c5e.tar.gz',
        'sha1'  : '8f49fef2c3d8f173b5ce0add486015a3439eed8c',
        'target': {
            'mingw-w64': {
